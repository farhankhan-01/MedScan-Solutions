...
class AuthBloc with ChangeNotifier {
  ...
  Future<AuthenticationResult> signUp({
    ...
    //TODO: Uncomment this line when you have a valid email service
  ...
  Future<UserData> getDbData({String userType, String uid}) async {
    DocumentSnapshot snapshot =
        await _firestore.collection(userType).doc(uid).get();
    if (snapshot.exists) {
      final data = snapshot.data();
      //convert object to map
      final json = jsonEncode(data);
      UserData uData = UserData.fromJson(jsonDecode(json));
      userData = uData;
